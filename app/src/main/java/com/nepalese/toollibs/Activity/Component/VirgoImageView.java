 ...
 * 3. 可加载网络图片
 */
public class VirgoImageView extends FrameLayout {
    ...
    public VirgoImageView(@NonNull Context context) {
        this(context, null);
    }

    public VirgoImageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VirgoImageView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
