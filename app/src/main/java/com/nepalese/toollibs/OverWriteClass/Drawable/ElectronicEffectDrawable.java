...
public class ElectronicEffectDrawable extends BaseEffectDrawable {
    ...
    private void init() {
        ...
        mLineRectWidth = ConvertUtil.dip2px(getContext(), mLineRectWidth);
        mDrawWidth = ConvertUtil.dip2px(getContext(), mDrawWidth);
        ...
        mLightWidth = ConvertUtil.dip2px(getContext(), mLightWidth);
    ...
    private void drawWare(Canvas canvas) {
        for (int i = 0; i < points.length; i++) {
            ...
            if (value > 0) {
                value = ConvertUtil.dip2px(getContext(), value * 0.5f + 5);
            }
