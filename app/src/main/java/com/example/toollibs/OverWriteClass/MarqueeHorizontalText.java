...
public class MarqueeHorizontalText extends View implements Runnable{
    private static final String TAG = "MarqueeHorizontalText";
    ...
    public MarqueeHorizontalText(Context context) {
        this(context, null);
    }

    public MarqueeHorizontalText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MarqueeHorizontalText(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                R.styleable.MarqueeHorizontalText);
//        textColor = tta.getColor(R.styleable.MarqueeHorizontalText_marquee_text_color, textColor);
//        isClickStop = tta.getBoolean(R.styleable.MarqueeHorizontalText_marquee_isclickalbe_stop, isClickStop);
//        isResetLocation = tta.getBoolean(R.styleable.MarqueeHorizontalText_marquee_is_resetLocation, isResetLocation);
//        speed = tta.getFloat(R.styleable.MarqueeHorizontalText_marquee_text_speed, speed);
//        textSize = tta.getFloat(R.styleable.MarqueeHorizontalText_marquee_text_size, textSize);
//        textDistance1 = tta.getInteger(R.styleable.MarqueeHorizontalText_marquee_text_distance, textDistance1);
//        startLocationDistance = tta.getFloat(R.styleable.MarqueeHorizontalText_marquee_text_startlocationdistance, startLocationDistance);
//        repetType = tta.getInt(R.styleable.MarqueeHorizontalText_marquee_repet_type, repetType);
//        tta.recycle();
//    }
