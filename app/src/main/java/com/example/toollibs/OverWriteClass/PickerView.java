...
public class PickerView extends View {
    private List<String> mDataList;//store data for displaying
    ...
    private int mColorText = 0x66ccff;
    ...
    public static final float SPEED = 10;//自动回滚到中间的速度

    private boolean canScroll = true;
    private boolean isInit = false;
    private boolean loop = true;  //新增字段 控制是否首尾相接循环显示 默认为循环显示
    ...
    public PickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.PickerView); //<attr name="isLoop" format="boolean" />
